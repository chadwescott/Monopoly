...
namespace Monopoly.DomainModel
{
    ...
    {
        private static RailroadSquare[] _railroadSquares;
        private static Square[] _squares;
        private const int NumberOfRailroadSquares = 4;
        ...
        public RailroadSquare[] GetRailroadSquares()
        {
            return _railroadSquares;
        }
